...
def random256(m):
  md = hashlib.sha256("RANDOM-SEED_X" + m)
...
x = 4471116765656567567567567543437908786556454569908908989767565
y = mulP(P,x)
...
Y = [89842579835247088208107078615896240854347102519363270172396807477122324936568L, 31337879419506147417718410624845000970193725837240762681835951002080538533837L]

print "\n\nThe verification of Schnorr's signature ", verifySchnorr(P, sig[0], y, sig[1], message)
